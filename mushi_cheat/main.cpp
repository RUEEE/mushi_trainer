...
void BuildSelections()
{
    ...
    s1.OnCheck = []() {
        char bytes[41] = {
            0x66, 0x83, 0x48, 0x02, 0x01, 0x90, 0x60, 0x8B, 0x05, 
            0xAC, 0x2A, 0xE1, 0x7A, 
            0x8B, 0x88, 0x78, 0x04, 0x00, 0x00, 0x6A, 0x64, 0x68, 0x00, 0x02, 0x00, 0x00, 0x6A, 0x7D, 0x6A, 0x05, 0xFF, 0xD1, 0x83, 0xC4, 0x10, 0x61, 0xE9, 0x8E, 0xF8, 0xFA, 0xFF};
        *(DWORD*)(bytes + 9) = g_game.base + 0x6C2AAC;
